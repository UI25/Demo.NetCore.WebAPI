...
namespace WebAPIModels.Data
{
    ...
    {  
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=.\\SQLEXPRESS;Initial Catalog=WebAPI;Integrated Security=True;TrustServerCertificate=True;User ID=sa; Password=Sygzalp09102016..; MultipleActiveResultSets=true;");         
        }
